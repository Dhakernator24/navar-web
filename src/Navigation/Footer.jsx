        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className='flex flex-col justify-center items-center'>
            ...
            <div class="flex mt-2 space-x-6 text-logo">
              <a className={classNameIcons} to target="_blank" rel="noreferrer">
          ...
          <div class="grid grid-cols-2 gap-8 lg:col-span-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <nav class="flex flex-col mt-4 space-y-2 text-sm">
                <a className={classNameLinks} to> Privacy Policy </a>
                <a className={classNameLinks} to> Terms &amp; Conditions </a>
                <a className={classNameLinks} to> Accessibility </a>
              </nav>
            </div>
          </div>
        </div>
