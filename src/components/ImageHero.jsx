...
function ImageHero({setCurrent}) {
	...
	return (
		<div
			style={{
				backgroundImage: `linear-gradient(to right, rgba(0, 40, 63, 0.8), rgba(0, 40, 63, 0.3)), url(${image_good})`
			}}
			className="flex shadow-2xl my-[80px] h-[calc(100vh-80px)] w-auto bg-cover 
			bg-center bg-no-repeat text-white">
			<div className="flex h-full w-full self-center lg:pl-[70px] md:pl-5 sm:pl-0">
